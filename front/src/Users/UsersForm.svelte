...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12" id="form">
                ...
                <div class="form-v10-content">
                    ...
                    >
                        ...
                        <div class="form-right">
                            <h2>Detalhes de contato e Pagamentos</h2>
                            <div class="form-row">
                                <input
                                    bind:this={txtUserLinktrade}
                                    type="text"
                                    name="tradeLink"
                                    class="tradeLink"
                                    id="tradeLink"
                                    placeholder="TradeLink Steam"
                                    required
                                />
                            </div>
